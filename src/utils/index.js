...
export function getSwapLink(token0Address, token1Address = null) {
  if (!token1Address) {
    return `https://app.dolomite.io/#/swap?inputCurrency=${token0Address}`
  } else {
    return `https://app.dolomite.io/#/swap?inputCurrency=${
...
export function getUniswapAppLink(linkVariable) {
  let baseUniswapUrl = 'https://app.dolomite.io'
  if (!linkVariable) {
